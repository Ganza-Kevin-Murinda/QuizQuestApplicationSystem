 ...
 */
public class InstructorProfilesDashboard extends javax.swing.JFrame {

    /**
     * Creates new form UserDashboard
     */

    String fname,email,instId,courseId;
    int Id;
    public InstructorProfilesDashboard(String Id, String name,String courseId,String email ) {
...
//                    theInstructor.getInstructorId(),
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        // TODO add your handling code here:
        String instEmail = emailTxt.getText();
        ...
        if(fNameTxt.getText().trim().isEmpty()){
        ...
        }else if(!isValidEmail(instEmail)){
            JOptionPane.showMessageDialog(this, "Email is required");
            ...
            if (pswdTxt.getText().equals(rePswdTxt.getText())){ 
                ...
                try {
                    ...
                    theInstructor.setEmail(instEmail); 
                    theInstructor.setPassword(pswdTxt.getText());


                    Registry registry = LocateRegistry.getRegistry("127.0.0.1",5000);
                    InstructorService service = (InstructorService) registry.lookup("Instructor");
                    Integer Id = service.updateInstructor(theInstructor); 
...
//        emailTxt.setEditable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InstructorProfilesDashboard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InstructorProfilesDashboard("","","","").setVisible(true);
            }
        });
    }
