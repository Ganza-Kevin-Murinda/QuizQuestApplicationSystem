...
public class UserCrudOp extends javax.swing.JFrame {
    ...
    public UserCrudOp(String Id, String name,String email) {
        initComponents();
        this.fname = name;
        this.email = email;
...
//        idTxt.setEditable(false); 
    ...
    public final void addRowDataToTable(){
        ...
        try {
            ...
            List<UserIdentity> userList = service.adminRetrieveUser();
...
//                        theUser.setCode(verificationCodeTxt.getText());                
                        ...
                        Registry registry = LocateRegistry.getRegistry("127.0.0.1",5000);
                        UserIdentityService service = (UserIdentityService) registry.lookup("User");
                        Integer Id = service.adminInactiveUser(theUser);
                        ...
                        if(Id != null){
                            ...
                            JOptionPane.showMessageDialog(this, "User Status Not Changed");
                        }
...
//                        theUser.setCode(verificationCodeTxt.getText());                
                        ...
                        if(Id != null){
                            JOptionPane.showMessageDialog(this, "User Status set to Active");
                            addRowDataToTable();
                            idTxt.setText("");
                            fNameTxt.setText("");
                            emailTxt.setText("");                    
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        // TODO add your handling code here:
        if(idTxt.getText().trim().isEmpty()){
            JOptionPane.showMessageDialog(this, "Use Only the User Id to search the User you need!");
        }else{
            try {
                ...
                if(userObj != null){
                    if(userObj.getUserType().equals("SystemAdmin")){
                        JOptionPane.showMessageDialog(this, "You are not allowed to see the information of this User");
