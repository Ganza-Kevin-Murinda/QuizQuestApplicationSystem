 ...
 */
public class ManageCourseDashboard extends javax.swing.JFrame {
    ...
    public ManageCourseDashboard(String Id, String name,String email) {
        
        initComponents();
        manageCourseBtn.setEnabled(false); 
        this.adminId = Id;
        this.fname = name;
        this.email = email;
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(65, 65, 65)
                .addComponent(manageInstructorBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(64, 64, 64)
    ...
    private void manageBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageBtnActionPerformed
        // TODO add your handling code here:
        setVisible(false); 
        new CourseCrudOp(adminId,fname, email).setVisible(true); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManageCourseDashboard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManageCourseDashboard("","","").setVisible(true);
            }
        });
    }
