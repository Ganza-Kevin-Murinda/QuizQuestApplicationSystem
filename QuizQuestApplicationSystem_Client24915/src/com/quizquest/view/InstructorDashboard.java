...
public class InstructorDashboard extends javax.swing.JFrame {
     ...
     */
    String fname,email,InstId,course,courseId;
    int unreadCount,id;
//    MessageDao dao = new MessageDao();
    public InstructorDashboard(String Id, String name, String email) {
//        unreadCount = dao.countUnReadMessages();
        ...
        this.course = getAllCourseNamesForInstructors();
        this.courseId = getAllCourseIdForInstructors();
        ...
        // Initialize and add the landing text message
            ...
            landingTxt.setText(
                "<html>"+ 
                    "Welcome, " + fname + "!" + "<br><br>" +    
                    "Greetings, Instructor! We're delighted to have you as part of our teaching team." + "<br><br>" +
                    "Here are some important notifications:" + "<br><br>" +        
                    "- You are assigned to prepare quizzes for the <b>" + course + "</b> course." + "<br><br>" +
                    "Feel free to start preparing quizzes for your course and engage your students effectively." + "<br><br>" + 
                "<html>" 
            );
        
    }
    public final String getAllCourseNamesForInstructors() {
    ...
    try {
        ...
        List<Instructor> instructorList = service.retrieveInstructor(id);

        for (Instructor instructor : instructorList) {
            List<Course> courses = instructor.getTheCourse();
            for (Course course : courses) {
                concatenatedNames.append(course.getCourseName()).append(", ");
            }
        }
    ...
    public final String getAllCourseIdForInstructors() {
    StringBuilder concatenatedId = new StringBuilder();
    ...
    try {
        ...
        for (Instructor instructor : instructorList) {
            List<Course> courses = instructor.getTheCourse();
            for (Course course : courses) {
                concatenatedId.append(course.getCourseId()).append(", ");
            }
        }

        // Remove the last comma and space
        if (concatenatedId.length() > 2) {
            concatenatedId.setLength(concatenatedId.length() - 2);
        }
    } catch (NotBoundException | RemoteException e) {
        e.printStackTrace(); 
    }

    return concatenatedId.toString();
}
    ...
    private void initComponents() {
        ...
        manageQuizBtn.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
            ...
            .addGroup(dashboardPanelLayout.createSequentialGroup()
                ...
                .addGroup(dashboardPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(dashboardPanelLayout.createSequentialGroup()
                        ...
                        .addGap(87, 87, 87))
                    .addComponent(manageQuizBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void profileBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_profileBtnActionPerformed
        // TODO add your handling code here:
        dispose();
        new InstructorProfilesDashboard(InstId,fname,courseId,email).setVisible(true);
    ...
    private void manageQuizBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageQuizBtnActionPerformed
        // TODO add your handling code here:
        dispose();
        new ManageQuizDashboard(InstId,fname,courseId,email).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InstructorDashboard("InstId","User","user@gmail").setVisible(true);
            }
        });
    }
