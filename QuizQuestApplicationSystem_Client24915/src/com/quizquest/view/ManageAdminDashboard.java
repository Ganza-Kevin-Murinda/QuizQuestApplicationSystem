 ...
 */
public class ManageAdminDashboard extends javax.swing.JFrame {
    ...
    public ManageAdminDashboard(String Id, String name,String email) {
    ...
    private void manageBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageBtnActionPerformed
        // TODO add your handling code here:
        dispose(); 
        new AdminCrudOp(adminId, fname, email).setVisible(true); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManageAdminDashboard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManageAdminDashboard("","","").setVisible(true);
            }
        });
    }
