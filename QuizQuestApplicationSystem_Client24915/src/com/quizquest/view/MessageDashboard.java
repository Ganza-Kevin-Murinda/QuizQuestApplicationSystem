 ...
 */
public class MessageDashboard extends javax.swing.JFrame {
    ...
    public MessageDashboard(String Id, String name,String email) {
    ...
    public final void addColumnHeaderName(){
        ...
        tableModel.addColumn("Sender ID");
    ...
    public final void addRowDataToTable(){
        ...
        try {
            ...
            List<Feedback> feedbackList = service.retrieveUnreadFeedback();

                for(Feedback theMessage : feedbackList){
                    tableModel.addRow(new Object[]{
                        theMessage.getFeedbackId(),
                        theMessage.getTheUser().getId(),
                        theMessage.getMessageTxt()
                    });
                }
    ...
    public final void addRowDatasToTable(){
        ...
        try {
            ...
            List<Feedback> feedbackList = service.retrieveAllFeedback();
    ...
    private void initComponents() {
        ...
        Title.setText("                   LIST OF USER FEEDBACK");
        ...
        markAsReadBtn.setBackground(new java.awt.Color(51, 0, 204));
        markAsReadBtn.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        ...
        mainPanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, mainPanelLayout.createSequentialGroup()
                ...
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(Title, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 613, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(markAsReadBtn, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 143, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(104, 104, 104))
        );
        mainPanelLayout.setVerticalGroup(
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                ...
                .addGap(29, 29, 29)
                .addComponent(markAsReadBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(31, 31, 31)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MessageDashboard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MessageDashboard("","","").setVisible(true);
            }
        });
    }
